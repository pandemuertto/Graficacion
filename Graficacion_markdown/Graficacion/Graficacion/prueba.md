...
def init_lighting():
    ...
    light_ambient = [1.0, 1.0, 1.0, 1.0]  # Luz ambiental
...
def main():
    ...
    titulo = "Esfera con textura e iluminación".encode("ascii", "ignore")
    ...
    texture_id = load_texture("C:\\Users\\paola\\OneDrive\\Documentos\\Graficacion\\Graficacion\\azul.jpg")  # Ruta de la imagen
