# Archivo: img-Escala-Grises.py

```python
# Este programa en Python, utilizando OpenCV y NumPy, carga una imagen a color y permite visualizar 
# por separado cada uno de sus canales de color (rojo, verde y azul). 
# También muestra una versión de la imagen con los canales reorganizados (RBG en lugar de RGB). 
# Esto sirve para analizar la composición de color de una imagen digital.
