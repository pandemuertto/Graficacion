# Archivo: framebuffer_blit_layers.py
...
import ctypes
_EXTENSION_NAME = 'GLES2_EXT_framebuffer_blit_layers'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GLES2,'GLES2_EXT_framebuffer_blit_layers',error_checker=_errors._error_checker)
