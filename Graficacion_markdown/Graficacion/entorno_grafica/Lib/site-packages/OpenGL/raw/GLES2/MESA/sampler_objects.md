...
import ctypes
_EXTENSION_NAME = 'GLES2_MESA_sampler_objects'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GLES2,'GLES2_MESA_sampler_objects',error_checker=_errors._error_checker)
