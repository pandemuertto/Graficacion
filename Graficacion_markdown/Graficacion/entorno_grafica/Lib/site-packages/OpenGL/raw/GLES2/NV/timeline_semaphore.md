...
import ctypes
_EXTENSION_NAME = 'GLES2_NV_timeline_semaphore'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GLES2,'GLES2_NV_timeline_semaphore',error_checker=_errors._error_checker)
