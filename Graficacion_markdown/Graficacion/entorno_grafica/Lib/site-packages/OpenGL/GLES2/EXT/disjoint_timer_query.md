# Archivo: disjoint_timer_query.py
...
# INPUT glGetInteger64vEXT.data size not checked against 'pname'
glGetInteger64vEXT=wrapper.wrapper(glGetInteger64vEXT).setInputArraySize(
    'data', None
)
